  ...
  return (
    <>
      <div
        ...
        className="w-full min-h-screen grid place-items-center place-content-center my-32"
      >
        ...
        <p
          data-aos="fade-up"
          data-aos-duration="1000"
          className="w-full max-w-[400px] m-auto text-[10px] text-center my-3 sm:text-sm md:whitespace-nowrap md:max-w-[600px] "
        >
        ...
        <p
          data-aos="fade-up"
          data-aos-duration="1000"
          className="w-full max-w-[350px] m-auto text-[10px] text-center sm:text-sm sm:max-w-[700px] "
        >
